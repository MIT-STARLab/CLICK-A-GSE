...
HK_SYS_FIXED_DATA_LEN = 35
HK_SYS_PROC_IDS = [1,2,3,4,5,6,128]
HK_SYS_PROC_NAMES = ["PAT","FPGA","PACKETIZER","DEPACKETIZER","HOUSEKEEPING","ROUTER","COMMANDHANDLER"]

#Timing Constants
UTC_TAI_OFFSET = 37 #TAI is exactly 37 seconds ahead of UTC

#Bus Command Constants
PAYLOAD_WRITE_APID = 15
PAYLOAD_WRITE_OP_CODE = 3
MACRO_EXECUTE_APID = 1
MACRO_EXECUTE_OP_CODE = 7

#Housekeeping Period Constants
HK_FPGA_CHECK_PD_DEFAULT = 5
HK_SYS_CHECK_PD_DEFAULT = 1
HK_CH_CHECK_PD_DEFAULT = 10
HK_LB_CHECK_PD_DEFAULT = 10
HK_PAT_CHECK_PD_DEFAULT = 10
HK_FPGA_CHECK_PD_MIN = 1
HK_SYS_CHECK_PD_MIN = 1
HK_CH_CHECK_PD_MIN = 2
HK_LB_CHECK_PD_MIN = 2
HK_PAT_CHECK_PD_MIN = 2