...
#Assumed Path: #C:\BCT\71sw0078_a_cosmos_click_edu\procedures\CLICK-A-GSE\test\test_hk_pat_tlm.rb
...
while(true)
    ...
    if !apid_check_bool
        puts "CCSDS APID Error! Received APID (= " + pl_ccsds_apid.to_s + ") not equal to PL_ECHO APID (= " + TLM_HK_PAT.to_s + "). "
    end
