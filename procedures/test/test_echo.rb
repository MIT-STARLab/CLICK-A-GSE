#Test Script - Echo
#Assumed Path: #C:\BCT\71sw0078_a_cosmos_click_edu\procedures\test\test_echo.rb
...
#Read the data bytes:
pl_data_and_crc_bytes = packet.read('PL_DATA')
#puts "pl_data_and_crc_bytes: ", pl_data_and_crc_bytes
#convert to packed string
pl_data_and_crc_packed = pl_data_and_crc_bytes.pack("C*")
...
#check crc_rx
packet_data_bytes = packet.buffer[26..(packet.buffer.length-CRC_LEN-1)]
